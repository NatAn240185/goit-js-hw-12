import{a as h,S as y,i as d}from"./assets/vendor-CRCB-GUD.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function i(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(e){if(e.ep)return;e.ep=!0;const s=i(e);fetch(e.href,s)}})();let m=15;async function p(r,o=1){const i="https://pixabay.com/api/?key=",a="46052576-a4ef4f0d52180e04b4399e04b",e=new URLSearchParams({q:r,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:m,page:o}),s=await h.get(`${i}${a}&${e}`),{data:{hits:l,totalHits:n}}=s;return{hits:l,totalHits:n}}function f(r){return r.map(({largeImageURL:o,webformatURL:i,tags:a,likes:e,views:s,comments:l,downloads:n})=>`<li class="gallery-item">
          <article class="card">
